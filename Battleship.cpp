...
{
    //Init game
    float gridSizeF = 75.f * w/1920.f;
    unsigned gridSizeU = 75 * w/1920.f;
    float dt = 0.f;
    sf::Clock dtClock;
    ...
    turnText.setCharacterSize(50 * w / 1920.f);

    sf::Text muteText;
    muteText.setFont(font);
    muteText.setCharacterSize(40 * w / 1920.f);
    ...
    while (window.isOpen())
    {
        ...
        else
        {
            ...
            muteText.setString(ss.str());
            centerTextAt(muteText, sf::Vector2f(w - 35, h - 125));
        ...
        while (window.pollEvent(e))
        {
            ...
            if (e.type == sf::Event::KeyReleased)
            {
                ...
                {
                    window.close();
                    w = sf::VideoMode::getDesktopMode().width, h = sf::VideoMode::getDesktopMode().height;
                    window.create(sf::VideoMode(w, h), "Battleship");
                }
            }
        }
